    ...
    columns: [
      {
        ...
        cardOrderIds: ['card-id-07', 'card-id-02', 'card-id-03', 'card-id-04', 'card-id-05', 'card-id-06', 'card-id-01'], // thu ta sap xep cac card
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
            ...
            cover: 'src/assets/car.jpg',
            memberIds: ['test-user-id-01', 'test-user-id-02', 'test-user-id-03'],
            status: 'watching',
            describe: null,
            attachments: ['test attachment 01', 'test attachment 02', 'test attachment 03']
          },
          { _id: 'card-id-02', boardId: 'board-id-01', columnId: 'column-id-01', title: 'Title of card 02', description: null, cover: null, memberIds: [], describe: 'kasfj', attachments: [] },
